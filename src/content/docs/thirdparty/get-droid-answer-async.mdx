...
> **Which one to choose?** If your system can wait 10-120 seconds, use the [Sync version](/thirdparty/endpoint/#8-get-droid-answer) — it's simpler. But if you have timeout limits or need queue systems, use the Async version.
...
If your system can wait and needs immediate answer, use [Sync version](/thirdparty/endpoint/#8-get-droid-answer) — it's simpler.
