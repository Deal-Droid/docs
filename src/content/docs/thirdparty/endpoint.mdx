...
<Aside type="tip">
**Looking for detailed specifications?** All request/response examples, parameters, and interactive testing are available in our Postman documentation — your single source of truth for the API.
</Aside>

<CardGrid>
  <Card title="📄 Full API Reference" icon="document">
    Detailed specifications for all 9 endpoints with complete request/response examples.
  </Card>
  <Card title="🧪 Interactive Testing" icon="rocket">
    Test endpoints directly in Postman with your own API token.
  </Card>
  <Card title="📋 Request Examples" icon="list-format">
    Copy-paste ready curl commands and code snippets.
  </Card>
  <Card title="⚠️ Error Handling" icon="warning">
    Complete error codes, messages, and troubleshooting guide.
  </Card>
</CardGrid>

<div class="flex flex-col gap-4" style="text-align: left; margin: 2rem 0;">
  <a href="https://documenter.getpostman.com/view/36788758/2sB3BDJAbP" target="_blank">
    <img src="/src/assets/third-party/postman-logo.png" alt="Postman Logo" width="200" />
  </a>
  
  **[View Full API Documentation on Postman](https://documenter.getpostman.com/view/36788758/2sB3BDJAbP)**
</div> 
