...
1. **How Intents Work** — Read the [Add Intents guide](/tuning/add-intent/) to learn how your AI detects customer intentions
...
2. Navigate to **Tuning** → **Intents** from the left sidebar
...
## Request Format: DealDroid → Your System
