...
<CardGrid stagger>
  <Card title="Well organized" icon="rocket">
    The transparency of our data will help you make the informed decisions you
    need to.
  </Card>
  <Card title="Other feature" icon="seti:json">
    The transparency of our data will help you make the informed decisions you
    need to.
  </Card>
</CardGrid>
